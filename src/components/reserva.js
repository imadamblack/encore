  ...
  return (
    <>
      <div className="max-w-[1390px] mx-auto mt-10 px-[30px] w-full relative">
        <div className="w-full flex flex-wrap sm:flex-nowrap flex-row justify-between items-center rounded-lg h-auto sm:h-[70px] ">

          {/* Campo LLEGADA */}
          {/* Añadimos un div wrapper para el DatePicker */}
          <div className="flex-1 text-center bg-white p-4 text-xl font-bold h-full border-l border-t border-b rounded-l-full relative flex flex-col justify-center items-center">
            LLEGADA
            <DatePicker
              selected={startDate}
          ...
          {/* Campo SALIDA */}
          <div className="flex-1 text-center bg-white p-4 text-xl font-bold h-full border relative flex flex-col justify-center items-center">
            SALIDA
            <DatePicker
              selected={endDate}
              onChange={handleDateChange}
