...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="container my-16 " >
        <ImageGrid
                images = {[{src: i00, alt: "imagen 01"},
                        {src: i01, alt: "imagen 02"},
                        {src: i02, alt: "imagen 03"},
                        {src: i03, alt: "imagen 04"},
                        {src: i04, alt: "imagen 05"},
                        {src: i05, alt: "imagen 06"},
                        {src: i06, alt: "imagen 07"},
                        {src: i07, alt: "imagen 08"},
                        {src: i08, alt: "imagen 09"},
                ]}
              />
      </section>
